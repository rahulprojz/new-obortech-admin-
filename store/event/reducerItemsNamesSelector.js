...
const ALL = { value: null, label: string.event.allItem }

const reducerItemsNamesSelector = (state, action) => {
    switch (action.type) {
        case 'initialize':
...
export default reducerItemsNamesSelector
