...
function ProfileCard(props) {
    ...
    const hasAccess = (userData?.role_id == process.env.ROLE_CEO || userData?.role_id == process.env.ROLE_MANAGER || userData?.role_id == process.env.ROLE_SENIOR_MANAGER|| userData?.role_id == process.env.ROLE_SENIOR_MANAGER)
        ...
        <>
            ...
            {userData && (
                <Button
                    ...
                    disabled={(showVerified == '1' ? (mvsVerifiedUser ? mvsVerifiedOrg || !hasAccess : true) : mvsVerifiedUser) || from != 'profile'}
