...
function InvalidateWarning({ isOpen, onToggle, onSubmit = () => { } }) {
    return (
        <Modal isOpen={isOpen} toggle={onToggle} className='customModal'>
            ...
            <ModalBody className='text-center mb-5'>
                ...
                <ModalFooter>
                    <LoaderButton className='btn btn-primary small-btn' type='button' text={string.confirmationModal.btnTxtOK} onClick={onSubmit} />
